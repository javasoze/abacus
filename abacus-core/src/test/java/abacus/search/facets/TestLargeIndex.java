...
public class TestLargeIndex {
  ...
  static void doAccumulateSeparateFields(FacetsCollector facetsCollector) throws IOException {
    ...
    LabelAndOrdFacetCounts categoryFacet = new LabelAndOrdFacetCounts("category",
        new SortedDocValuesOrdReader("category"), facetsCollector);
    ...
    LabelAndOrdFacetCounts tagsFacet = new LabelAndOrdFacetCounts("tags",
        new SortedSetDocValuesOrdReader("tags"), facetsCollector);
  ...
  static void doAccumulateFacetsField(SortedSetDocValuesReaderState state,
      FacetsCollector facetsCollector) throws IOException {

    SortedSetDocValuesFacetCounts facetCounts = new SortedSetDocValuesFacetCounts(state,
        facetsCollector);
